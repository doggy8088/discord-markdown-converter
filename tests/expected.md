...
- **模型名稱**：`openai/glm-5.2`
- **成功請求數**：269
- **Prompt Tokens**（輸入）：108,465,056
- **Completion Tokens**（輸出）：122,951
- **總消耗 Tokens**：108,588,007
- **總花費**（USD）：$152.39
- **佔比**：100%
### 關鍵數據特徵：
...
* 2026-08-26：344 次請求 ➡️ 5,344 萬 tokens（平均 ~15.5 萬/req）
* 2026-08-27：214 次請求 ➡️ 7,295 萬 tokens（平均 ~34.1 萬/req）
* 2026-08-28：269 次請求 ➡️ **10,858 萬 tokens（平均 ~40.3 萬/req）**
